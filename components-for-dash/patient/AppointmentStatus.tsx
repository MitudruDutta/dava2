        ...
        <CardContent>
          <Tabs defaultValue="all" className="space-y-4">
            <TabsList className="grid w-full grid-cols-5">
              ...
              <TabsTrigger value="booked">Booked ({filterAppointments('booked').length})</TabsTrigger>
              <TabsTrigger value="awaiting_diagnosis">Diagnosis ({filterAppointments('awaiting_diagnosis').length})</TabsTrigger>
              <TabsTrigger value="payment_requested">Payment ({filterAppointments('payment_requested').length})</TabsTrigger>
